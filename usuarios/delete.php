...
<!-- Menu superior y lateral -->
  ...
  <div class="container">
    ...
    <br><h2>Eliminación del usuario</h2>
      ...
      <div class="col-md-6">
            ...
            <div class="card card-danger" style="border: 1px solid #777777">
              ...
              <div class="card-body">
                ...
                <input type="text" class="form-control" id="nombres" value="<?php echo $nombres ?>" readonly>
                </div>
                <div class="form-group">
                ...
                <input type="password" class="form-control" id="password_user" value="<?php echo $password_user ?>" readonly>
                </div>
                <div class="form-group">
