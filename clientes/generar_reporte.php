...
<td style="background-color: #c0c0c0;text-align: center">Nombre del Cliente</td>
<td style="background-color: #c0c0c0;text-align: center">Rut/Ci del Cliente</td>
<td style="background-color: #c0c0c0;text-align: center">Placa del auto</td>
</tr>
';
$contador = 0;
...
foreach($clientes as $cliente){
    ...
    $rut_ci_cliente = $cliente['rut_ci_cliente'];
    ...
    <td style="text-align: center">'.$rut_ci_cliente.'</td>
